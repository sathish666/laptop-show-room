                ...
                <div class="col-12 col-lg-10">
                    <div class="menu_area">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <!-- Logo -->
                            <a class="navbar-brand" href="index.php">RL</a>
...
<?php session_start(); 			print "<font color='skyblue'>WELCOME   </font>".$_SESSION['username']; ?>
    ...
    <section class="footer-contact-area section_padding_100 clearfix" id="contact">
        <div class="container">
			...
			{
			$pdet=mysqli_query($c,"select name,message from feedback");
			while($ans1=mysqli_fetch_array($pdet)){

			print "<table><tr><th><font color='blue'>ID</font> </th><td>$id</td></tr><tr><th><font color='blue'>NAME </font></th><td>$ans1[0]</td></tr><tr><th><font color='blue'>REVIEW </font> </th><td>$ans1[1]</td></tr></table>";
			$id=$id+1;		
			}
			}
			else
