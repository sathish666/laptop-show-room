                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                <ul class="navbar-nav ml-auto" id="nav">
                                    <li class="nav-item active"><a class="nav-link" href="cus.php">LIST</a></li>
...
<?php session_start(); 			print "<font color='skyblue'>WELCOME   </font>".$_SESSION['username']; ?>
    ...
    <section class="footer-contact-area section_padding_100 clearfix" id="contact">
        <div class="container">
			...
			{
			$pdet=mysqli_query($c,"select username,email from signup");
			while($ans1=mysqli_fetch_array($pdet)){

			print "<table><tr><th><font color='blue'>ID</font> </th><td>$id</td></tr><tr><th><font color='blue'>NAME </font></th><td>$ans1[0]</td></tr><tr><th><font color='blue'>Email </font> </th><td>$ans1[1]</td></tr></table>";
			$id=$id+1;		
			}
			}
			else
